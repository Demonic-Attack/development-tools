...
// @ts-expect-error eslint-plugin-es-x is not typed
export { default as eslintEsXPlugin } from 'eslint-plugin-es-x';
...
export { default as eslintReactDomPlugin } from 'eslint-plugin-react-dom';
