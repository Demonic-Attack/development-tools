...
export interface RuleOptions {
   ...
   */
  'no-commented-code/no-commented-code'?: Linter.RuleEntry<[]>
  /**
   ...
   */
  'sort-class-members/sort-class-members'?: Linter.RuleEntry<SortClassMembersSortClassMembers>
  /**
...
type SortClassMembersSortClassMembers = []|[_SortClassMembersSortClassMembersHttpsGithubComBryanrsmithEslintPluginSortClassMembersV1]
type _SortClassMembersSortClassMembers_Order = (string | {
  name?: string
...
interface _SortClassMembersSortClassMembersHttpsGithubComBryanrsmithEslintPluginSortClassMembersV1 {
  order?: _SortClassMembersSortClassMembers_Order
  groups?: {
    [k: string]: _SortClassMembersSortClassMembers_Order
  }
...
export type ConfigNames = 'js/setup' | 'js/rules' | 'tailwindcss/rules' | 'node/rules' | 'jsx/setup' | 'perfectionist/rules' | 'unicorn/rules' | 'react/setup' | 'react/rules' | 'next/rules' | 'no-commented-code/rules' | 'esx/rules' | 'import/rules' | 'ts/setup' | 'ts/rules' | 'prettier/rules' | 'arca/rules' | 'comments/rules' | 'mutation/rules' | 'promise/rules' | 'regexp/rules' | 'sort-class-members/rules' | 'sonarjs/rules'
